...
func Test_ptr_struct_kind(t *testing.T) {
...
func Test_ptr_struct_gostring(t *testing.T) {
	type TestObject struct {
		Field1 int
		Field2 int
	}
...
func Test_ptr_struct_num_field(t *testing.T) {
	type TestObject struct {
		Field1 int
		Field2 int
	}
...
func Test_ptr_struct_random_accessible(t *testing.T) {
	type TestObject struct {
		Field1 int `json:"field1"`
		Field2 int `json:"field2"`
	}
...
func Test_ptr_struct_get_by_array_index(t *testing.T) {
	type TestObject struct {
		Field1 int `json:"field1"`
		Field2 int `json:"field2"`
	}
...
func Test_ptr_struct_set_by_array_index(t *testing.T) {
	type TestObject struct {
		Field1 int `json:"field1"`
		Field2 int `json:"field2"`
	}
	...
	should.Equal(3, v.Field2)
}

func Test_ptr_struct_get_by_array_index_out_of_bound(t *testing.T) {
	type TestObject struct {
		Field1 int `json:"field1"`
		Field2 int `json:"field2"`
	}
...
func Test_ptr_struct_iterate_array(t *testing.T) {
	type TestObject struct {
		Field1 int `json:"field1"`
		Field2 int `json:"field2"`
	}
...
func Test_ptr_struct_fill_array(t *testing.T) {
	type TestObject struct {
		Field1 int `json:"field1"`
		Field2 int `json:"field2"`
	}
