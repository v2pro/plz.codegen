...
func Test_ptr_ptr_array_kind(t *testing.T) {
...
func Test_ptr_ptr_array_gostring(t *testing.T) {
	should := require.New(t)
	v1 := [3]int{}
	v2 := &v1
	v := &v2
...
func Test_ptr_ptr_array_elem(t *testing.T) {
	should := require.New(t)
	v1 := [3]int{}
	v2 := &v1
	v := &v2
...
func Test_ptr_ptr_array_random_accessible(t *testing.T) {
	should := require.New(t)
	v1 := [3]int{}
	v2 := &v1
	v := &v2
...
func Test_ptr_ptr_array_get_by_array_index(t *testing.T) {
	should := require.New(t)
	v1 := [3]int{1, 2, 3}
	v2 := &v1
	v := &v2
...
func Test_ptr_ptr_array_set_by_array_index(t *testing.T) {
	should := require.New(t)
	v1 := [3]int{1, 2, 3}
	v2 := &v1
	v := &v2
...
func Test_ptr_ptr_array_iterate_array(t *testing.T) {
	should := require.New(t)
	v1 := [3]int{1, 2, 3}
	v2 := &v1
	v := &v2
...
func Test_ptr_ptr_array_fill_array(t *testing.T) {
	should := require.New(t)
	v1 := [3]int{}
	v2 := &v1
	v := &v2
